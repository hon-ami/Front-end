...
const ContentCarouselRight = ({textOne, textTwo, imgOne, imgTwo, imgThree, imgFour, imgFive, Two, Three, Four, Five}) => {
            ...
            <Col xs={10} mdOffset={1} md={4}>
                <ScrollAnimation animateIn="fadeInUp" offset={100} duration={2} animateOnce={true}>
                    <div className="content-carousel">
                        <button className="content-carousel__prev" onClick={prev}><img className="content-carousel__leftArrow" src={arrow}/></button>
                        {Two === 1 &&
                        <Whirligig
                        ...
                        <button className="content-carousel__next" onClick={next}><img className="content-carousel__rightArrow" src={arrow}/></button>
                    </div>
                </ScrollAnimation>
            </Col>
        </Row>
...
export default ContentCarouselRight;